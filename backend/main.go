...
func handleReq() {
	...
	r.HandleFunc("/cal/walk/bike/marta", computeWalkBikeMartaCal).Methods("GET", "OPTIONS")
	r.HandleFunc("/cal/walk/marta/walk", computeWalkMartaWalkCal).Methods("GET", "OPTIONS")
...
func computeWalkBikeMartaCal(w http.ResponseWriter, r *http.Request) {
...
func computeWalkMartaWalkCal(w http.ResponseWriter, r *http.Request) {
